...
window2title = tkinter.Label(window2, text="ReniChat Sign In", bg="black", fg="orange", font="bold")
window2title.pack()
...
imagelabel=tkinter.Label(window2, image=photo)
imagelabel.pack()

#heading
window2label = tkinter.Label(window2, text="Enter your username: ", bg="black", fg="orange")
window2label.pack()

#input field
username = tkinter.Entry(window2, bg="black", fg="orange")
username.pack()
...
savebutton = tkinter.Button(window2, text="Save", command=save_username, bg="orange", fg="black")
savebutton.pack()
